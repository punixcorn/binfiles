  ...
  */
  try {
    ...
    desc.add_options()("help,h", "print this message")(
        ...
        "push,p", opt::value<string>()->implicit_value(""),
        "push into origin")("Clone,C", opt::value<string>(),
    ...
    if (args.count("Clone")) {
      string tempstr{args["Clone"].as<string>()};
...
auto createOnlineRepo() -> void {
  ...
  snprintf(crepo, 500,
           ...
           token.c_str(), reponame.c_str(), repodes.c_str(),
